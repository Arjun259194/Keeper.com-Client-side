...
const Home: FC = () => {
  return (
    <div className="w-full h-screen overflow-y-scroll overflow-x-hidden bg-gradient-to-tl from-prime to-sec">
      <div className="w-5/6 mx-auto">
        ...
        <main className="">
          <div className="relative flex flex-col items-center xl:items-start">
            ...
            <img
              className="hidden xl:block xl:absolute xl:-top-5 xl:right-0 xl:rotate-[25deg] z-0 "
              src={bulbImage}
              alt="3D bulb image"
            />
          </div>
